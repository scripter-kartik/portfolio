        ...
        <div className='fixed top-0 left-0 right-0 z-[9999] bg-black'>
            <div className="flex justify-center py-3 sm:py-4 px-4 sm:px-6 lg:px-8">
                <div className="w-full max-w-[1324px] h-[56px] sm:h-[61px] flex items-center justify-between">
                    ...
                    >
                        <span
                            className={`w-6 h-0.5 bg-[#ABB2BF] transition-all duration-300 ${isMenuOpen ? 'rotate-45 translate-y-2' : ''
                                }`}
                        ></span>
                        <span
                            className={`w-6 h-0.5 bg-[#ABB2BF] transition-all duration-300 ${isMenuOpen ? 'opacity-0' : ''
                                }`}
                        ></span>
                        <span
                            className={`w-6 h-0.5 bg-[#ABB2BF] transition-all duration-300 ${isMenuOpen ? '-rotate-45 -translate-y-2' : ''
            ...
            >
                <div className="flex flex-col py-4 px-6 gap-5 sm:gap-6">
                    <div className="flex items-center gap-2">
                        <img className="w-[10px] h-[16px] sm:w-[12px] sm:h-[18px]" src="/hashtag.png" alt="" />
                        <button
                            onClick={() => scrollToSection('home')}
