...
const Navbar = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className={`lg:hidden fixed top-[52px] sm:top-[58px] left-0 right-0 bottom-0 bg-[#05070c]/98 backdrop-blur-2xl border-t border-white/[0.05] transition-all duration-300 flex flex-col p-6 gap-6 z-40 ${
